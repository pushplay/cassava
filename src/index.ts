...
export class Router {
        ...
        return (evt: ProxyEvent, ctx: awslambda.Context, callback: ProxyResponseCallback) => {
            this.routeProxyEvent(evt)
                .then(res => {
                    ...
                    console.log("Error thrown during execution.\n", err);
                    callback(null, {
    ...
    private async routeProxyEvent(pevt: ProxyEvent): Promise<ProxyResponse> {
        ...
        const evt = Router.proxyEventToRouterEvent(pevt);
        ...
        return Router.routerResponseToProxyResponse(resp);
    }

    private static proxyEventToRouterEvent(evt: ProxyEvent): RouterEvent {
    ...
    private static routerResponseToProxyResponse(resp: RouterResponse): ProxyResponse {
